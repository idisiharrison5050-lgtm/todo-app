  ...
  static ThemeData _build(Brightness brightness) {
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        bodyLarge: TextStyle(fontSize: 16, height: 1.45, color: dark ? Colors.white70 : const Color(0xFF555862)),
        bodyMedium: TextStyle(fontSize: 14, height: 1.4, color: dark ? Colors.white60 : const Color(0xFF6A6D76)),
      ),
