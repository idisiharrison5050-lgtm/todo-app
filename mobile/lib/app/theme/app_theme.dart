  ...
  static ThemeData _build(Brightness brightness) {
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        headlineMedium: TextStyle(fontSize: 27, height: 1.07, fontWeight: FontWeight.w850, letterSpacing: -1.0, color: scheme.onSurface),
        headlineSmall: TextStyle(fontSize: 23, height: 1.1, fontWeight: FontWeight.w850, letterSpacing: -.65, color: scheme.onSurface),
        titleLarge: TextStyle(fontSize: 20, height: 1.15, fontWeight: FontWeight.w850, letterSpacing: -.45, color: scheme.onSurface),
        titleMedium: TextStyle(fontSize: 16, height: 1.25, fontWeight: FontWeight.w750, color: scheme.onSurface),
        titleSmall: TextStyle(fontSize: 14, height: 1.25, fontWeight: FontWeight.w750, color: scheme.onSurface),
        ...
        labelMedium: TextStyle(fontSize: 12, height: 1.1, fontWeight: FontWeight.w750, color: muted),
        labelSmall: TextStyle(fontSize: 11, height: 1.1, fontWeight: FontWeight.w750, color: muted),
      ),
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: scheme.outlineVariant.withValues(alpha: dark ? .9 : .8), width: .8),
        ),
      ),
      listTileTheme: ListTileThemeData(
        ...
        titleTextStyle: TextStyle(fontSize: 15, fontWeight: FontWeight.w750, color: scheme.onSurface),
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: dark ? const Color(0xFF13151B) : Colors.white,
        ...
        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(19), borderSide: BorderSide(color: scheme.outlineVariant)),
        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(19), borderSide: BorderSide(color: scheme.primary, width: 1.7)),
      ),
      navigationBarTheme: NavigationBarThemeData(
        height: 82,
        elevation: 0,
        backgroundColor: dark ? const Color(0xFF0C0D12) : Colors.white,
        surfaceTintColor: Colors.transparent,
        indicatorColor: scheme.primary.withValues(alpha: .14),
        labelTextStyle: WidgetStateProperty.resolveWith((states) => TextStyle(
          fontSize: 11,
          fontWeight: states.contains(WidgetState.selected) ? FontWeight.w850 : FontWeight.w650,
      ...
      chipTheme: ChipThemeData(
        ...
        labelStyle: TextStyle(fontWeight: FontWeight.w750, fontSize: 12, color: scheme.onSurface),
      ),
      ...
      tooltipTheme: TooltipThemeData(
        decoration: BoxDecoration(color: scheme.inverseSurface, borderRadius: BorderRadius.circular(11)),
        textStyle: TextStyle(color: scheme.onInverseSurface, fontSize: 12, fontWeight: FontWeight.w650),
      ),
      dialogTheme: DialogThemeData(
        elevation: 0,
        backgroundColor: dark ? const Color(0xFF15171E) : Colors.white,
        surfaceTintColor: Colors.transparent,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
      ),
      bottomSheetTheme: BottomSheetThemeData(
        backgroundColor: dark ? const Color(0xFF111319) : Colors.white,
        surfaceTintColor: Colors.transparent,
        modalBackgroundColor: dark ? const Color(0xFF111319) : Colors.white,
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        backgroundColor: dark ? const Color(0xFFE9E9EF) : const Color(0xFF282A31),
      ),
      filledButtonTheme: FilledButtonThemeData(
        style: FilledButton.styleFrom(
          ...
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(17)),
          textStyle: const TextStyle(fontSize: 14, fontWeight: FontWeight.w850),
        ),
      ),
