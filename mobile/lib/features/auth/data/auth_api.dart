...
class AuthApi {
  ...
  AuthApiException _mapError(DioException error) {
    ...
    if (statusCode == 401) {
      return AuthApiException('The email or password is incorrect.', statusCode: statusCode);
    }
    ...
    if (error.type == DioExceptionType.connectionError ||
      ...
      return AuthApiException(
        'Cannot reach the Todo server. Check that the backend is running and the app API address is correct.',
