    ...
    return Scaffold(
      body: Stack(children: [
        ...
        SafeArea(child: Center(child: SingleChildScrollView(padding: const EdgeInsets.fromLTRB(22, 30, 22, 28), child: ConstrainedBox(constraints: const BoxConstraints(maxWidth: 500), child: Column(children: [
          ...
          TextButton(onPressed: _busy ? null : () => setState(() => _register = !_register), child: Text(_register ? 'Already have an account?  Sign in' : 'New here?  Create an account')),
...
class _BrandHeader extends StatelessWidget {
  ...
  final ColorScheme scheme; final ThemeData theme;
  @override Widget build(BuildContext context) => Row(children: [
    ...
    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('Todo', style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w900)), Text('Plan. Focus. Finish.', style: theme.textTheme.bodySmall?.copyWith(fontWeight: FontWeight.w600, color: scheme.onSurfaceVariant))]),
  ]);
}

class _Header extends StatelessWidget {
  const _Header({super.key, required this.register, required this.theme, required this.scheme});
  final bool register; final ThemeData theme; final ColorScheme scheme;
...
class _PasswordStrength extends StatelessWidget {
  ...
  final String password; final ColorScheme scheme;
...
class _Glow extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) => IgnorePointer(child: Container(width: size, height: size, decoration: BoxDecoration(shape: BoxShape.circle, color: color, boxShadow: [BoxShadow(color: color, blurRadius: 100, spreadRadius: 25)])));
}
