...
class SettingsView extends StatelessWidget {
  ...
  final TaskStore store;
  @override Widget build(BuildContext context) => SafeArea(child: AnimatedBuilder(animation: store, builder: (context, _) => ListView(padding: const EdgeInsets.fromLTRB(20, 24, 20, 40), children: [
    ...
    Card(child: Column(children: const [ListTile(leading: Icon(Icons.storage_outlined), title: Text('Local storage'), subtitle: Text('Tasks persist after closing and reopening the app.')), Divider(height: 1), ListTile(leading: Icon(Icons.alarm_outlined), title: Text('Reminder behavior'), subtitle: Text('New scheduled tasks remind once by default. You can turn reminders off per task.'))])),
