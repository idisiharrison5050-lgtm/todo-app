              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(Icons.check_rounded, color: scheme.onPrimary, size: 25),
                  ),
              ...
              child: PageView(
                ...
                children: [
                  _Slide(
                    ...
                    eyebrow: 'A calmer way to plan',
                    title: 'Turn a busy day into a clear plan.',
                    body: 'Capture tasks, give them a moment, and let Todo keep the details organized for you.',
                    scheme: scheme,
                    features: const ['Fast task capture', 'Today and upcoming views', 'Priorities, categories and favorites'],
                  ),
                  _Slide(
                    icon: Icons.sync_rounded,
                    eyebrow: 'Your workspace follows you',
                    title: 'Stay productive, even when life goes offline.',
                    body: 'Work locally when your connection disappears. Changes are queued safely and synced when you are back online.',
                    scheme: scheme,
                    features: const ['Offline-first task capture', 'Automatic sync when connected', 'Account-scoped workspace'],
                  ),
                  _Slide(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Row(
                    children: List.generate(3, (index) {
                      ...
                      return AnimatedContainer(
                        ...
                        width: active ? 25 : 7,
                        height: 7,
                        decoration: BoxDecoration(color: active ? scheme.primary : scheme.outlineVariant, borderRadius: BorderRadius.circular(10)),
                      );
                    }),
                  ),
                  const Spacer(),
                  FilledButton.icon(
                    onPressed: _next,
                    icon: Icon(_page == 2 ? Icons.check_rounded : Icons.arrow_forward_rounded),
                    label: Text(_page == 2 ? 'Start planning' : 'Continue'),
                  ),
                ],
              ),
            ),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: scheme.primary.withValues(alpha: .20), blurRadius: 38, offset: const Offset(0, 17))],
            ),
            child: Icon(icon, color: scheme.onPrimary, size: 56),
          ),
          ...
          ConstrainedBox(constraints: const BoxConstraints(maxWidth: 480), child: Text(body, textAlign: TextAlign.center, style: theme.textTheme.bodyLarge?.copyWith(color: scheme.onSurfaceVariant, height: 1.5))),
          if (features.isNotEmpty) ...[
            ...
            ConstrainedBox(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(color: scheme.surfaceContainerLow, borderRadius: BorderRadius.circular(18), border: Border.all(color: scheme.outlineVariant.withValues(alpha: .7))),
                child: Column(children: features.map((feature) => Padding(padding: const EdgeInsets.symmetric(vertical: 4), child: Row(children: [Icon(Icons.check_circle_rounded, size: 17, color: scheme.primary), const SizedBox(width: 9), Expanded(child: Text(feature, style: const TextStyle(fontWeight: FontWeight.w700)))]))).toList()),
              ),
            ),
          ],
