        ...
        slivers: [
          ...
          SliverPadding(
            ...
            sliver: SliverToBoxAdapter(
              child: _Progress(progress: progress, completed: completed, total: all.length),
            ),
          ),
          if (overdue > 0)
            SliverPadding(
      ...
      child: CustomScrollView(
        slivers: [
          SliverPadding(
            ...
            sliver: SliverToBoxAdapter(child: Text('Find anything', style: Theme.of(context).textTheme.displaySmall?.copyWith(fontWeight: FontWeight.w900))),
          ),
          SliverPadding(
          ...
          SliverToBoxAdapter(
            child: SingleChildScrollView(
              ...
              child: Row(
                children: ['All', 'Active', 'Completed', 'Favorites'].map<Widget>((value) => Padding(padding: const EdgeInsets.only(right: 8), child: ChoiceChip(label: Text(value), selected: _filter == value, onSelected: (_) => setState(() => _filter = value)))).toList(),
              ),
            ),
          ),
          SliverPadding(
