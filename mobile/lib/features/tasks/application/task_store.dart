...
class TaskStore extends ChangeNotifier {
  ...
  Future<void> addTask({
    ...
    final task = Task(
      id: _uuid.v4(), title: normalizedTitle, notes: notes.trim(),
      dueAt: normalizedDueAt, reminderType: reminderType,
      reminderInterval: reminderInterval, priority: priority,
    );
  ...
  Future<void> updateTask(
    ...
    final updated = _tasks[index].copyWith(
      ...
      reminderType: reminderType, reminderInterval: reminderInterval,
      priority: priority,
    );
