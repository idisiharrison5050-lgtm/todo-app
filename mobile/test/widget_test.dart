...
void main() {
  ...
  testWidgets('creates and completes a task from the home workspace', (WidgetTester tester) async {
    ...
    await tester.scrollUntilVisible(find.text('Buy groceries'), 500, scrollable: homeScrollable);
    ...
    await tester.scrollUntilVisible(find.text('Checklist'), 500, scrollable: detailScrollable);
    expect(find.text('Checklist'), findsOneWidget);
    expect(find.text('Activity'), findsOneWidget);
    await tester.scrollUntilVisible(find.text('Complete task'), 500, scrollable: detailScrollable);
